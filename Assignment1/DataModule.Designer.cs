namespace Assignment1
{
    partial class DataModule
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.daEvents = new System.Data.OleDb.OleDbDataAdapter();
            ...
            this.daLocations = new System.Data.OleDb.OleDbDataAdapter();
            ...
            this.dsKaioordinate = new Assignment1.dsKaioordinate();
            ((System.ComponentModel.ISupportInitialize)(this.dsKaioordinate)).BeginInit();
            this.SuspendLayout();
            // 
            // oleDbSelectCommand1
            // 
            this.oleDbSelectCommand1.CommandText = "SELECT KaiID, EventID, KaiName, PreparationRequired, PreparationMinutes, ServeQua" +
    "ntity\r\nFROM     KAI\r\nORDER BY KaiID";
            this.oleDbSelectCommand1.Connection = this.ctnKaioordinate;
            // 
            // oleDbInsertCommand1
            // 
            this.oleDbInsertCommand1.CommandText = "INSERT INTO `KAI` (`EventID`, `KaiName`, `PreparationRequired`, `PreparationMinut" +
    "es`, `ServeQuantity`) VALUES (?, ?, ?, ?, ?)";
            ...
            // daKai
            // 
            this.daKai.DeleteCommand = this.oleDbDeleteCommand1;
            this.daKai.InsertCommand = this.oleDbInsertCommand1;
            this.daKai.SelectCommand = this.oleDbSelectCommand1;
            ...
            this.daKai.UpdateCommand = this.oleDbUpdateCommand1;
            // 
            // ctnKaioordinate
            // 
            this.ctnKaioordinate.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users\\shane\\source\\repos\\Assignm" +
    "ent1\\kai-oordinate.mdb";
            // 
            // oleDbSelectCommand2
            // 
            this.oleDbSelectCommand2.CommandText = "SELECT EventID, EventName, LocationID, EventDate\r\nFROM     EVENT\r\nORDER BY EventI" +
    "D";
            this.oleDbSelectCommand2.Connection = this.ctnKaioordinate;
            // 
            // oleDbInsertCommand2
            // 
            this.oleDbInsertCommand2.CommandText = "INSERT INTO `EVENT` (`EventName`, `LocationID`, `EventDate`) VALUES (?, ?, ?)";
            ...
            // daEvents
            // 
            this.daEvents.DeleteCommand = this.oleDbDeleteCommand2;
            this.daEvents.InsertCommand = this.oleDbInsertCommand2;
            this.daEvents.SelectCommand = this.oleDbSelectCommand2;
            this.daEvents.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
            ...
            this.daEvents.UpdateCommand = this.oleDbUpdateCommand2;
            // 
            // oleDbSelectCommand3
            // 
    ...
    "?, ?)";
            ...
            // daEventRegistration
            // 
            this.daEventRegistration.DeleteCommand = this.oleDbDeleteCommand3;
            this.daEventRegistration.InsertCommand = this.oleDbInsertCommand3;
            this.daEventRegistration.SelectCommand = this.oleDbSelectCommand3;
            ...
            this.daEventRegistration.UpdateCommand = this.oleDbUpdateCommand3;
            // 
            // oleDbSelectCommand4
            // 
    ...
    "` = ?)))";
            ...
            // daLocations
            // 
            this.daLocations.DeleteCommand = this.oleDbDeleteCommand4;
            this.daLocations.InsertCommand = this.oleDbInsertCommand4;
            this.daLocations.SelectCommand = this.oleDbSelectCommand4;
            this.daLocations.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
            ...
            this.daLocations.UpdateCommand = this.oleDbUpdateCommand4;
            // 
            // oleDbSelectCommand5
            // 
    ...
    "S (?, ?, ?, ?, ?)";
        ...
        private System.Data.OleDb.OleDbDataAdapter daEvents;
        ...
        private System.Data.OleDb.OleDbDataAdapter daLocations;
        ...
        public System.Data.OleDb.OleDbDataAdapter daKai;
    }
}